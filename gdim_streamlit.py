...
PLOTLY_BASE = dict(
    ...
    xaxis=dict(gridcolor="rgba(0,212,255,0.06)", zerolinecolor="rgba(0,212,255,0.1)", tickfont=dict(size=10)),
    yaxis=dict(gridcolor="rgba(0,212,255,0.06)", zerolinecolor="rgba(0,212,255,0.1)", tickfont=dict(size=10)),
...
def chart_trend_forecast():
    ...
    fig.update_layout(**PLOTLY_BASE, height=300,
        xaxis=dict(**PLOTLY_BASE["xaxis"],range=[0,100],ticksuffix="%"),
...
def chart_shortage_bar():
    ...
    fig.update_layout(**PLOTLY_BASE, height=340,
        xaxis=dict(**PLOTLY_BASE["xaxis"],range=[0,100]),
        margin=dict(l=0,r=10,t=10,b=10))
    return fig
...
def chart_innovation_map():
    ...
    fig.update_layout(**PLOTLY_BASE, height=440, geo=dict(bgcolor=C["bg"]),
...
def chart_interaction_gauge(score, level):
    ...
    fig.update_layout(**PLOTLY_BASE, height=250, margin=dict(l=20,r=20,t=50,b=10))
    return fig
...
def chart_network_sankey():
    ...
    fig.update_layout(**PLOTLY_BASE, height=380, margin=dict(l=10,r=10,t=20,b=10))
    return fig
...
def chart_country_risk():
    ...
    fig.update_layout(**PLOTLY_BASE, height=320, barmode="group",
        legend=dict(orientation="h",y=-0.2,bgcolor="rgba(0,0,0,0)",font=dict(size=9)))
    return fig
...
def chart_trial_gauge(prob, label):
    ...
    fig.update_layout(**PLOTLY_BASE, height=280, margin=dict(l=20,r=20,t=50,b=10))
    return fig
...
def chart_phase_waterfall():
    ...
    fig.update_layout(**PLOTLY_BASE, height=280,
        yaxis=dict(**PLOTLY_BASE["yaxis"],title="Success Rate (%)",range=[0,115]),
        margin=dict(l=10,r=10,t=30,b=10))
    return fig
...
def chart_gap_scatter():
    ...
    fig.update_layout(**PLOTLY_BASE, height=420,
        xaxis=dict(**PLOTLY_BASE["xaxis"],title="Research Activity (%)",range=[-5,105]),
        yaxis=dict(**PLOTLY_BASE["yaxis"],title="Disease Burden (%)",range=[-5,105]))
    return fig
...
with tabs[3]:
    ...
    with col1:
        ...
        fig = go.Figure(go.Bar(
            ...
            textfont=dict(size=10)))
        fig.update_layout(**PLOTLY_BASE, height=240, margin=dict(l=0,r=10,t=10,b=10))
    ...
    with col2:
        ...
        fig2 = go.Figure(go.Pie(
            ...
            textfont=dict(size=10,family="DM Mono,monospace")))
        fig2.update_layout(**PLOTLY_BASE, height=240, margin=dict(l=10,r=10,t=20,b=10))
...
with tabs[4]:
    ...
    with col1:
        ...
        fig.update_layout(**PLOTLY_BASE, height=280,
            xaxis=dict(**PLOTLY_BASE["xaxis"],range=[7,10]),
            margin=dict(l=0,r=10,t=10,b=10))
        st.plotly_chart(fig, use_container_width=True, config={"displayModeBar":False})
    with col2:
...
with tabs[5]:
    ...
    with col1:
        ...
        fig = go.Figure(go.Bar(
            ...
            textposition="inside",textfont=dict(size=9,family="DM Mono,monospace")))
        fig.update_layout(**PLOTLY_BASE, height=260, margin=dict(l=0,r=10,t=10,b=10))
        st.plotly_chart(fig, use_container_width=True, config={"displayModeBar":False})
    with col2:
...
with tabs[6]:
    ...
    with c2:
        ...
        fig.update_layout(**PLOTLY_BASE, height=260,
            yaxis=dict(**PLOTLY_BASE["yaxis"],range=[0,95]),
            margin=dict(l=10,r=10,t=10,b=40))
        st.plotly_chart(fig, use_container_width=True, config={"displayModeBar":False})
    with c3:
        ...
        fig2 = go.Figure(go.Pie(
            ...
            textfont=dict(size=10,family="DM Mono,monospace")))
        fig2.update_layout(**PLOTLY_BASE, height=260, margin=dict(l=10,r=10,t=20,b=10))
        st.plotly_chart(fig2, use_container_width=True, config={"displayModeBar":False})
...
with tabs[7]:
    ...
    with col2:
        ...
        fig.update_layout(**PLOTLY_BASE, height=280,
            xaxis=dict(**PLOTLY_BASE["xaxis"],range=[0,10]),
            margin=dict(l=0,r=10,t=10,b=10))
        st.plotly_chart(fig, use_container_width=True, config={"displayModeBar":False})
